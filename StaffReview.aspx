<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="StaffReview.aspx.cs" Inherits="Blood.WebForm15" %>
    ...
    <div>
       <asp:GridView ID="GridView1" runat="server" CssClass="gridview" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="staffrating" HeaderText="Staff Rating" />
                                    <asp:BoundField DataField="remarks" HeaderText="Staff Remarks" />
